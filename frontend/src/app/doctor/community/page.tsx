      ...
      <Tabs defaultValue="posts" className="w-full">
        ...
        <TabsContent value="posts" className="mt-4 space-y-4">
            ...
            {!showPostForm ? (
              ...
              <Card className="border border-border shadow-sm">
                <CardContent className="p-5 space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="post-category" className="text-sm">
                      Category
                    </Label>
                    <Select
                      value={postCategory}
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="post-content"
                      placeholder="Share health awareness information..."
                      value={postContent}
          ...
          {loadingPosts ? (
            ...
            <EmptyState
              icon={MessageSquare}
              title="No posts yet"
              description="Create your first awareness post to share health information with patients."
        ...
        <TabsContent value="qa" className="mt-4 space-y-4">
          {loadingQuestions ? (
            ...
            <EmptyState
              icon={HelpCircle}
              title="No questions from patients yet"
              description="When patients ask health questions, they'll appear here for you to answer."
            />
          ) : (
            <div className="space-y-3 max-w-2xl">
              {questions.map((q) => {
                ...
                const isLoadingThis = loadingAnswers === q.id;
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="space-y-1 min-w-0">
                            ...
                            <div className="flex items-center gap-3 text-xs text-muted-foreground pt-1">
                              <span>
                                Patient: {getDisplayName(qaNamesMap, q.userId)}
                              </span>
                              <span>
